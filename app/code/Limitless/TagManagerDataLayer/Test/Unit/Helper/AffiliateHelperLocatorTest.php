...
class AffiliateHelperLocatorTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        return new AffiliateHelperLocator($this->mockObjectManager, $affiliateBlockPool);
    }
    ...
    {
        $expectedMessage = sprintf('The affiliate code is invalid: "%s"', $expected);
    ...
    {
        $expectedMessage = sprintf('No helper registered for affiliate code "%s"', $validAffiliateCode);
        $this->setExpectedException(\InvalidArgumentException::class, $expectedMessage);
