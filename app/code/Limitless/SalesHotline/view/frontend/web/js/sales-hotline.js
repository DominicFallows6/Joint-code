define(['jquery'], function($) {
    ...
    return function (data) {
        ...
        function getOpeningTimes() {
            ...
            var openTime = openClosedTime[0].trim().replace(/:/g, "");
            var closedTime = openClosedTime[1].trim().replace(/:/g, "");
            var checkOpeningTimesFrequency = (data.checkInterval * 1) * 1000;

            if (currentTime >= openTime && currentTime < closedTime && open == 1) {
