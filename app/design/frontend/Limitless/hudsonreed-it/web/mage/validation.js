...
(function (factory) {
    ...
    var rules = {
        ...
        "validate-email": [
            ...
            'Inserisci un indirizzo e-mail valido (ad.es: pietrobianchi@domain.com).'
        ],
            ...
            function (v, elm) {
                ...
                if (result == false) {
                    validator.passwordErrorMessage = $.mage.__(
                        "La lunghezza minima di questo campo deve essere pari o superiore a %1." +
        ...
        "validate-greater-than-zero": [
            ...
            'Si prega di inserire un numero maggiore di 0 in questo campo.'
        ],
        "validate-css-length": [
            function (v) {
                if (v !== '') {
