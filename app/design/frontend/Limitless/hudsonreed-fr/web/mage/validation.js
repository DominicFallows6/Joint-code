...
(function (factory) {
    ...
    var rules = {
        "equalTo": [
            ...
            $.mage.__('Veuillez entrer la même valeur une fois de plus.')
        ],
        "max-words": [
        ...
        "validate-email": [
            ...
            'Veuillez entrer une adresse e-mail valide (par ex. dupont@gmail.com).'
        ],
            ...
            function (v, elm) {
                ...
                if (result == false) {
                    validator.passwordErrorMessage = $.mage.__(
                        "La longueur minimale de ce champs doit être égale ou supérieure à %1 symbols." +
                        " Les espaces avant et après ne seront pas pris en compte."
                ...
                if (counter < passwordMinCharacterSets) {
                    result = false;
                    validator.passwordErrorMessage = $.mage.__(
                        "Le minimum de différents types de caractères dans le mot de passe est %1." +
                        " Types de caractères : minuscules, majuscules, chiffres & caractères spéciaux."
        ...
        "validate-greater-than-zero": [
            ...
            'Veuillez entrer un nombre supérieur à 0 dans ce champ.'
        ],
        "validate-css-length": [
            function (v) {
                if (v !== '') {
