...
(function (factory) {
    ...
    var rules = {
        "equalTo": [
            ...
            $.mage.__('Rogamos vuelva a introducir la misma información.')
        ],
        "max-words": [
        ...
        "validate-email": [
            ...
            'Rogamos introduzca una dirección de correo electrónico válida (e.j: juanmoreno@domain.com).'
        ],
            ...
            function (v, elm) {
                ...
                if (result == false) {
                    validator.passwordErrorMessage = $.mage.__(
                        "La longitud mínima de este campo debe ser igual o mayor a %1 símbolos." +
                        " Los espacios iniciales y finales se omitirán."
                ...
                if (counter < passwordMinCharacterSets) {
                    result = false;
                    validator.passwordErrorMessage = $.mage.__(
                        "El mínimo de distintas clases de caracteres en una contraseña es de %1." +
                        " Tipos de caracteres : minúsculas, mayúsculas, dígitos, caracteres especiales."
        ...
        "validate-greater-than-zero": [
            ...
            'Rogamos introduzca un número superior a 0 en este campo.'
        ],
        "validate-css-length": [
            function (v) {
                if (v !== '') {
