...
(function (factory) {
    ...
    var rules = {
        "equalTo": [
            ...
            $.mage.__('Bitte nochmals eingeben.')
        ],
        "max-words": [
        ...
        "validate-email": [
            ...
            'Bitte geben Sie eine gültige E-Mail-Adresse ein (zB.: maxmustermann@domain.de).'
        ],
            ...
            function (v, elm) {
                ...
                if (result == false) {
                    validator.passwordErrorMessage = $.mage.__(
                        "Die Mindestlänge dieses Feldes muss gleich oder größer als %1 Zeichenzahlen sein." +
                ...
                if (counter < passwordMinCharacterSets) {
                    result = false;
                    validator.passwordErrorMessage = $.mage.__(
                        "Das Minimum der verschiedenen Klassen von Zeichen im Passwort ist %1." +
                        " Klassen von Zeichen: Kleinbuchstaben, Großbuchstaben, Ziffern, Sonderzeichen."
        ...
        "validate-greater-than-zero": [
            ...
            'Bitte geben Sie eine Zahl ein die größer ist als 0.'
        ],
        "validate-css-length": [
            function (v) {
                if (v !== '') {
