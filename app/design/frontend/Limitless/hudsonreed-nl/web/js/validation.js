...
(function (factory) {
    ...
    var rules = {
        ...
        "validate-email": [
            ...
            'Vul a.u.b een geldig email adres in (bijv. jansmit@domain.nl).'
        ],
            ...
            function (v, elm) {
                ...
                if (result == false) {
                    validator.passwordErrorMessage = $.mage.__(
                        "De minimale lengte van dit veld moet gelijk of groter zijn dan %1 leestekens." +
                ...
                if (counter < passwordMinCharacterSets) {
                    result = false;
                    validator.passwordErrorMessage = $.mage.__(
                        "Het minimum aantal verschillende speciale letters & tekens in een wachtwoord is %1." +
                        " Met speciale letters en tekens verwijzen we naar: kleine letters, hoofdletters, cijfers, speciale tekens."
        ...
        "validate-greater-than-zero": [
            ...
            'Noteer een nummer groter dan 0 in dit veld.'
        ],
        "validate-css-length": [
            function (v) {
                if (v !== '') {
